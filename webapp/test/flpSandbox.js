		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#valiantlistdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"valiantlistdetail-display": {
								"semanticObject": "valiantlistdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=valiantlistdetail",
									"url": sap.ui.require.toUrl("valiantlistdetail")
								}
							}
						}
					}
